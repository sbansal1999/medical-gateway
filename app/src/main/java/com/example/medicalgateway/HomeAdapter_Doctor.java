...
public class HomeAdapter_Doctor extends RecyclerView.Adapter<HomeViewHolder_Doctor>  {
    ArrayList<HomeDataModel> data;
    int PreviousPosition = 0;
    Context context ;
    public HomeAdapter_Doctor(ArrayList<HomeDataModel> data, Context context)
    {
        this.data = data;
    ...
    @NonNull
    @Override
    public HomeViewHolder_Doctor onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view= inflater.inflate(R.layout.singlehome_row,parent,false);

        return new HomeViewHolder_Doctor(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeViewHolder_Doctor holder, int position) {
